...
("Batclaw", 0, False),
("Grapple Gun", 3, True),
("Batsignal", 0, False), ("Utility Belt", 1, True),
("Batmobile Tires", 4, True)
]

gadgets.sort(key= lambda x:x[2],reverse = True)

sorted_gadgets = sorted(gadgets, key = lambda x : (-x[1],x[0]) , reverse = False)

print("The sorted list according to ur requirement is :")
